...
const char * const BITCOIN_CONF_FILENAME = "toadcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Toadcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Toadcoin";
#else
    // Unix
    return pathRet / ".toadcoin";
#endif
#endif
}
