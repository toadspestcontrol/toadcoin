...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " toadcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  toadcoin-tx [options] <hex-tx> [commands]  Update hex-encoded toadcoin transaction\n" +
            "or:     toadcoin-tx [options] -create [commands]   Create hex-encoded toadcoin transaction\n" +
            "\n";
