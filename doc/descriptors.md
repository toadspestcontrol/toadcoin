# Support for Output Descriptors in Toadcoin Core

Since Toadcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Toadcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Toadcoin Core wallets, a convenience function `combo` is
