...
"""Verify that starting toadcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start toadcoin with -h for help text")
        ...
        self.log.info("Start toadcoin with -version for version information")
        ...
        self.log.info("Start toadcoind with -fakearg to make sure it does not start")
